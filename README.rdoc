...
* Style the add/edit form and show view page; maybe make add/edit/deleteback buttons display Twitter bootstrap {Glyphicons}[http://getbootstrap.com/components/#glyphicons]

* User authentication using {Devise}[https://github.com/plataformatec/devise] gem, {hint}[http://guides.railsgirls.com/devise/]

* Commenting using {acts_as_commentable}[https://github.com/jackdempsey/acts_as_commentable] gem
